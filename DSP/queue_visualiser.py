"""visualiser for the queue. similar to stack visualiser.
code inspired by stack_visualiser, also used code from Task 1.3 in the Week 10 tutorial sheet.
Adjusted for queue format """
import pygame
